...
func NewExportService(db *store.DB, profileService *ProfileService, linkService *LinkService) *ExportService {
...
func (s *ExportService) exportToJSON(profile *model.Profile, links []*model.Link) ([]byte, string, error) {
...
func (s *ExportService) exportToCSV(profile *model.Profile, links []*model.Link) ([]byte, string, error) {
...
func (s *ExportService) exportToHTML(profile *model.Profile, links []*model.Link) ([]byte, string, error) {
...
func (s *ExportService) exportToVCard(profile *model.Profile, links []*model.Link) ([]byte, string, error) {
