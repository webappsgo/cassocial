...
func NewProfileService(db *store.DB) *ProfileService {
	return &ProfileService{db: db}
}

// Create creates a new profile
func (s *ProfileService) Create(userID string, profile *model.Profile) error {
...
func (s *ProfileService) GetByID(id string) (*model.Profile, error) {
...
func (s *ProfileService) GetBySlug(slug string) (*model.Profile, error) {
...
func (s *ProfileService) Update(profile *model.Profile) error {
	// Validate profile
	if err := profile.Validate(); err != nil {
		return fmt.Errorf("profile validation failed: %w", err)
	}
...
func (s *ProfileService) Duplicate(profileID, userID string) (*model.Profile, error) {
...
func (s *ProfileService) GetQRCodeSettings(profileID string) (*model.QRCodeSettings, error) {
...
func (s *ProfileService) UpdateQRCodeSettings(settings *model.QRCodeSettings) error {
	// Validate settings
