...
func NewAuth(db *database.DB, jwtSecret string) *Auth {
	if jwtSecret == "" {
...
func (a *Auth) Register(username, email, password string) (*models.User, error) {
...
func (a *Auth) Login(username, password string) (string, *models.User, error) {
...
func (a *Auth) LoginWith2FA(userID, code string) (string, *models.User, error) {
	// Get user
...
func (a *Auth) GetUserByUsername(username string) (*models.User, error) {
	user := &models.User{}
	query := `SELECT id, username, email, password_hash, role, status, created_at, updated_at,
			  last_login, email_verified, two_factor_enabled, two_factor_secret
...
func (a *Auth) GetUserByUsernameOrEmail(usernameOrEmail string) (*models.User, error) {
	user := &models.User{}
	query := `SELECT id, username, email, password_hash, role, status, created_at, updated_at,
			  last_login, email_verified, two_factor_enabled, two_factor_secret
